...
const UsersDetails = ({
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <Header className="fixed top-0 left-0" distributorData={distributorData} isAdmin={isAdmin} accountId={accountId} accountName={accountName} selectedDistributor={selectedDistributor}/>
