    ...
    <div className="p-4 grid grid-cols-3 gap-4">
      ...
      <div className="bg-white shadow-lg p-4 rounded-lg">
        ...
        <PieChart width={250} height={200}>
          <Pie data={productData} dataKey="value" cx="50%" cy="50%" outerRadius={50}>
            {productData.map((entry, index) => (
              <Cell key={`cell-${index}`} fill={COLORS[index]} />
            ))}
          </Pie>
        </PieChart>
        <button className="bg-green-700 text-white px-3 py-1 rounded-md">View Report</button>
      </div>
      ...
      <div className="bg-white shadow-lg p-4 rounded-lg">
        ...
        <PieChart width={250} height={200}>
          <Pie data={distributorData} dataKey="value" cx="50%" cy="50%" outerRadius={50}>
      ...
      <div className="bg-white shadow-lg p-4 rounded-lg col-span-2">
        ...
        <ResponsiveContainer width="100%" height={200}>
          <LineChart data={lineChartData}>
            ...
            <YAxis />
            <Tooltip />
            <Line type="monotone" dataKey="current" stroke="#1E88E5" strokeWidth={2} />
